...
function Cadastro() {
  ...
  // efeito que vai direcionar o usuário para a tela de login quando o ID for diferente de zero, ou seja, quando conseguir cadastrar no backend e ele devolver um json com ID preenchido pro front, esse UseEffect fica olhando modificações no estado do Usuario para conseguir direcionar a navegação
  useEffect(() => {
    if (usuario.id !== 0) {
      retornar();
    }
